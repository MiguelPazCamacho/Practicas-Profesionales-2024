...
class LidarSubscriber:
    ...
    def pose_callback(self, msg):
        # Actualizar la posición del robot cuando se recibe un mensaje de pose
    ...
    def save_to_csv(self, points):
        ...
        with open(file_name, 'w') as f:
            # Escribir la posición del robot en la primera fila
            print(f'Robot Position,{self.robot_x},{self.robot_y}\n')
            f.write(f'Robot Position,{self.robot_x},{self.robot_y}\n')
            # Escribir las coordenadas de los puntos de intersección
            f.write('x,y\n')
            for point in points:
